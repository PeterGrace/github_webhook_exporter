...
For example, after all four version fields are `0.1.3`, consume the published image and chart:
...
`dist/github-webhook-exporter-0.1.3.tgz`. `just helm-kind-acceptance` confirms API acceptance for
