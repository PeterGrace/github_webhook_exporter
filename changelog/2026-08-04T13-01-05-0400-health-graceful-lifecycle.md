...
- Added controlled-time drain timeout tests, real in-flight request draining, process-level SIGINT
  and SIGTERM coverage, restart persistence coverage, and lifecycle/health redaction checks.
